...
public class por1_1 extends AppCompatActivity {
    ...
    public void por1_2_2(View view) {
        if (success2 == 1) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por5);
    ...
    public void por1_2_3(View view) {
        if (success2 == 2) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por3);
    ...
    public void por1_3_1(View view) {
        if (success3 == 0) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por6);
    ...
    public void por1_3_2(View view) {
        if (success3 == 1) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por8);
    ...
    public void por1_3_3(View view) {
        if (success3 == 2) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por9);
    ...
    public void por1_3_4(View view) {
        if (success3 == 3) {
            ...
            ImageView imageView3 = (ImageView) findViewById(R.id.por7);
